 ...
 * @author R
 */
@FacesConverter("kategoriaConverter")
public class KategoriaConverter implements Converter {

    @Override
    public String getAsString(FacesContext fc, UIComponent uic, Object o) {
        if (!(o instanceof Kategoria)) {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String string) {
        ...
        Kategoria kategoria = em.find(Kategoria.class, i);
        em.close();
        return kategoria;
    }
}
